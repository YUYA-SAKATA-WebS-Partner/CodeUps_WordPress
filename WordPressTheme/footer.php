...
<footer class="footer footer-layout <?php if(is_404()) echo 'footer-layout--nomargin'; ?>">
      ...
      <div class="footer-nav__box">
        <ul class="footer-nav__items">
          <li class="footer-nav__item">
            ...
            <ul class="footer-nav__sub-items">
              <li class="footer-nav__sub-item"><a href="<?php echo $license; ?>">ライセンス取得</a></li>
              <li class="footer-nav__sub-item"><a href="<?php echo $experience; ?>">体験ダイビング</a></li>
              <li class="footer-nav__sub-item"><a href="<?php echo $diving; ?>">ファンダイビング</a></li>
            </ul>
          </li>
        ...
        <ul class="footer-nav__items">
          <li class="footer-nav__item">
            ...
            <ul class="footer-nav__sub-items">
              <li class="footer-nav__sub-item"><a href="<?php echo $information; ?>#license">ライセンス講習</a></li>
              <li class="footer-nav__sub-item"><a href="<?php echo $information; ?>#experience">体験ダイビング</a></li>
              <li class="footer-nav__sub-item"><a href="<?php echo $information; ?>#fun-diving">ファンダイビング</a></li>
            </ul>
          </li>
      ...
      <div class="footer-nav__box">
        <ul class="footer-nav__items">
          ...
          <li class="footer-nav__item">
            ...
            <ul class="footer-nav__sub-items">
              <li class="footer-nav__sub-item"><a href="<?php echo $price; ?>#price-license">ライセンス講習</a></li>
              <li class="footer-nav__sub-item"><a href="<?php echo $price; ?>#price-experience">体験ダイビング</a></li>
              <li class="footer-nav__sub-item"><a href="<?php echo $price; ?>#price-fun-diving">ファンダイビング</a></li>
            </ul>
          </li>
        </ul>
        <ul class="footer-nav__items">
          <li class="footer-nav__item"><a href="<?php echo $faq; ?>"><span>よくある質問</span></a></li>
          <li class="footer-nav__item"><a href="<?php echo $policy; ?>"><span>プライバシー<br class="u-mobile">ポリシー</span></a>
          </li>
