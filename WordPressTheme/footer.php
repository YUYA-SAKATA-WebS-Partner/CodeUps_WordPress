    ...
    <nav class="footer__nav footer-nav">
      <div class="footer-nav__box">
        <ul class="footer-nav__items">
          ...
          <li class="footer-nav__item"><a href="<?php echo esc_url(home_url('/about-us')); ?>"><span>私たちについて</span></a>
          </li>
        </ul>
        <ul class="footer-nav__items">
          <li class="footer-nav__item">
      ...
      <div class="footer-nav__box">
        <ul class="footer-nav__items">
          <li class="footer-nav__item"><a href="<?php echo esc_url(home_url('/voice')); ?>"><span>お客様の声</span></a></li>
          <li class="footer-nav__item">
        ...
        <ul class="footer-nav__items">
          <li class="footer-nav__item"><a href="<?php echo esc_url(home_url('/faq')); ?>"><span>よくある質問</span></a></li>
          <li class="footer-nav__item"><a href="<?php echo esc_url(home_url('/privacy-policy')); ?>"><span>プライバシー<br
                  class="u-mobile">ポリシー</span></a></li>
          <li class="footer-nav__item"><a href="<?php echo esc_url(home_url('/terms')); ?>"><span>利用規約</span></a></li>
          <li class="footer-nav__item"><a href="<?php echo esc_url(home_url('/contact')); ?>"><span>お問い合わせ</span></a>
          </li>
          <li class="footer-nav__item"><a href="<?php echo esc_url(home_url('/sitemap')); ?>"><span>サイトマップ</span></a>
          </li>
        </ul>
      </div>
    </nav>
